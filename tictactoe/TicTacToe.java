        ...
        while(noWinner){
            ...
            try {
                ...
                if (inputRow < 0 || inputRow > 2 || inputColumn < 0 || inputColumn > 2) {
                    System.out.println("Incorrect input, please enter row and column between 0 and 2.");
                    continue; // Ask for input again
                }
                break; // Valid input, exit the loop
            } catch (Exception e) {
                System.out.println("Invalid input format. Please enter row and column as numbers separated by a comma (e.g., 1,2).");
            }
        }
